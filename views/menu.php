            ...
            <ul class="navbar-nav">
              ...
              { ?>
                <li class="nav-item dropdown navbar-right">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        ...
                        <li><a class="dropdown-item" href="<?=PATH?>/Usuarios/Estado/Habilitado">Usuarios
                                habilitados</a></li>
                        <li><a class="dropdown-item" href="<?=PATH?>/Clientes/Estado/Habilitado">Clientes
                                habilitados</a></li>
                        <li><a class="dropdown-item" href="<?=PATH?>/Usuarios/Estado/Deshabilitado">Usuarios
                                deshabilitados</a></li>
                        <li><a class="dropdown-item" href="<?=PATH?>/Clientes/Estado/Deshabilitado">Clientes
                                deshabilitados</a></li>
              ...
              { ?>
                        ...
                        <li><a class="dropdown-item"
                                href="<?=PATH?>/Productos/categoria/<?=$categoria['nombre_categoria']?>"><?=$categoria['nombre_categoria']?></a>
                        </li>
                        <?php  }?>
                    </ul>
                </li>
