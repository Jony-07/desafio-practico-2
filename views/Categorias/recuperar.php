...
<head>
    ...
    <title>Recuperar Categoria</title>
    <?php
...
<?php
    ...
    <div class="d-flex justify-content-center">
        ...
        <legend style="color: #343a40;" class="text-center ">Recuperar categoria</legend>
        <?php  foreach ($categoriax as $categorix)
                     {?>
                        <form method="POST" action="<?=PATH?>/Categorias/Recover/<?=$categorix['id_categoria']?>" enctype="multipart/form-data" class="formulario">
                ...
                <input readonly type="text" class="form-control" value="<?=isset($categorix)?$categorix['nombre_categoria']:''?>"  name="nombre_categoria" id="nombre_categoria">
                </div>
                ...
                <div class="d-flex justify-content-center">
                <input type="submit" class="btn btn-dark" value="Recuperar" name="Recuperar"> &nbsp;
