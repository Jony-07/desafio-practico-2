...
<?php
    ...
    <div class="d-flex justify-content-center">
        ...
        <legend style="color:#084594" class="text-center text-dark">Ingresar nueva categoria</legend>
                        <form method="POST" action="<?=PATH?>/Categorias/add" enctype="multipart/form-data" class="formulario">
                ...
                <input type="text" class="form-control" value="<?=isset($categorix)?$categorix['id_categoria']:''?>" name="id_categoria" id="id_categoria">
                </div>
