...
<?php
    ...
    <div class="d-flex justify-content-center">
        ...
        <legend style="color:#dc3545" class="text-center ">Eliminar categoria</legend>
        <?php  foreach ($categoriax as $categorix)
                     {?>
                        <form method="POST" action="<?=PATH?>/Categorias/Eliminar/<?=$categorix['id_categoria']?>" enctype="multipart/form-data" class="formulario">
