...
<link href="<?=PATH?>/views/assets/css/nav.css" rel="stylesheet" type="text/css"/>
<link href="<?=PATH?>/views/assets/css/all.css" rel="stylesheet" type="text/css"/>
...
<script src="<?=PATH?>/views/assets/js/bootstrap.min.js"></script>
