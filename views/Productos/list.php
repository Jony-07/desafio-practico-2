                ...
                <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="listado">
                   ...
                   ?>
                        <tr < id="id_<?=$producto['codigo_producto']?>">
                            ...
                            <td>   
                                <a title="Editar" class="btn btn-primary btn-circle" href="<?=PATH?>/Productos/Edit/<?=$producto['codigo_producto']?>"><i class="bi bi-pencil-square"></i></span></a> &nbsp;
                                <a title="Eliminar"  class="btn btn-danger btn-circle" href="<?=PATH?>/Productos/Delete/<?=$producto['codigo_producto']?>"><i class="bi bi-trash3-fill"></i></span></a>
                            </td>
                        </tr>
                        <?php
                        }
