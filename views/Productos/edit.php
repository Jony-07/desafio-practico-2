    ...
    <div class="d-flex justify-content-center">
        <div class="col-md-10 my-5">
            <?php  foreach ($productos as $producto)
                     {?>
                         <legend style="color:#084594" class="text-center text-dark"><?=$producto['nombre_producto']?></legend>
                        <form method="POST" action="<?=PATH?>/Productos/Editar/<?=$producto['codigo_producto']?>" enctype="multipart/form-data" class="formulario">
