    ...
    <div class="d-flex justify-content-center">
        <div class="col-md-10 my-5">
            <?php  foreach ($productos as $producto)
                     {?>
                        <form method="POST" action="<?=PATH?>/Productos/Recover/<?=$producto['codigo_producto']?>" enctype="multipart/form-data" class="formulario">
                
                        <div class="form-group text-center">
                    <legend style="color: #343a40;" class="text-center ">¿Deseas recuperar este producto: <?=$producto['nombre_producto']?>?</legend>
                </div>
                <?php
                        if(isset($errores)){
                            if(count($errores)>0){
