                ...
                <table class="table table-striped table-bordered table-hover table-responsive table-condensed" id="listado">
                   ...
                   ?>
                        <tr  id="id_<?=$producto['codigo_producto']?>">
                            ...
                            <td>  
                            <center><a title="Ver más" class="btn btn-primary btn-circle" href="<?=PATH?>/Facturas/Ventas/<?=$producto['codigo_producto']?>/<?=$producto['id_factura']?>/<?=$producto['codigo_cliente']?>"><i class="bi bi-eye-fill"></i></span></a></center>

       
                        </td>
                        </tr>
                        <input type="hidden" name="codigo_cliente" id="codigo_cliente" value="<?=isset($producto)?$producto['codigo_cliente']:''?>">
