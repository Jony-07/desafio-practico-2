                   ...
                   ?>
                            ...
                            <tr < id="id_<?=$producto['codigo_producto']?>">
                                ...
                                <td>
                                    ...
                                    <center><a title="Ver más" class="btn btn-primary btn-circle"
                                            href="<?=PATH?>/Facturas/Reportes/<?=$producto['codigo_producto']?>/<?=$producto['id_factura']?>"><i
                                                class="bi bi-eye-fill"></i></span></a></center>
